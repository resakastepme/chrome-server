...
class FileController extends Controller
{
    ...
    public function storeAnalisaFile(Request $r)
    {
        ...
        if ($filePath) {
            $ApiKey = 'c72b57abb6787b0854d428b9892c0a6a28a7076f7550a508ed8eb46d7326b4a8';
            $fileScanner = new \Monaz\VirusTotal\File($ApiKey);
            $resp = $fileScanner->scan($filePath);
        ...
        //             'contents' => 'data:application/x-zip-compressed;name=' . $fixName . '.zip;base64,' . $base64,
        //             'headers' => [
    ...
    public function getAnalyzeFile(Request $r)
    {
        ...
        if ($status == 'queued') {
            ...
            return response()->json([
                ...
                'index' => $index,
                'data' => $responseBody,
                'malwarebytes' => $responseBody['data']['attributes']['results']['Fortinet']
            ]);
        }
    }
